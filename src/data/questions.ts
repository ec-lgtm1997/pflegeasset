...
export const hardQuestions: HardQuestion[] = [
...

  {
    ...
    modelAnswer: "Inspektion: Beurteilung der Wirbelsäulenkrümmung, der Beckenstabilität und der ausgeprägten Schonhaltung (Rumpfneigung zur Gegenseite zur Entlastung der komprimierten Wurzel) [cite: 85].\n\nSpezifischer Test: Überprüfung der Kniestreckung (M. quadriceps femoris) gegen den Widerstand des Untersuchers sowie Überprüfung des Patellarsehnenreflexes (PSR), der bei einer L4-Kompression abgeschwächt oder aufgehoben sein kann [cite: 86].\n\nLagerung: Die Patientin befindet sich in Rückenlage[cite: 89]. Zur Schmerzlinderung im Akutstadium kann eine Stufenbettlagerung (90°-Beugung in Hüft- und Kniegelenken) mittels Schaumstoffwürfel indiziert sein [cite: 89].\n\nBefundbestätigung: Eine tastbare Kraftminderung bei der Knieextension (Kraftgrad < 5) und ein im Seitenvergleich abgeschwächter PSR untermauern den L4-Verdacht[cite: 90]."
  },
  {
    id: "schwer-001-q4",
    caseId: "case-01",
    ...
    modelAnswer: "1. Akuter Schmerz (00132) R/T Kompression der lumbalen Nervenwurzel L4 A/E/B Schmerzausstrahlung in den rechten ventrolateralen Oberschenkel, Schmerzscore > 6/10, Einnahme einer Schonhaltung (Rumpfneigung)[cite: 92].\n\n2. Beeinträchtigte körperliche Mobilität (00085) R/T neuromuskulärer Schädigung und motorischer Schwäche des M. quadriceps femoris sowie Schmerzen A/E/B Angabe von Instabilitätsgefühl im rechten Knie, Einschränkung des Bewegungsumfanges und Schonhaltung[cite: 93]."
  },
  {
    id: "schwer-001-q5",
    caseId: "case-01",
    ...
    modelAnswer: "I (Identifikation): \"Hallo, hier spricht [Name] von Station [X]. Ich rufe wegen der neu aufgenommenen Patientin, Frau S., geboren am [Datum], an.\" [cite: 95]\nS (Situation): \"Frau S. klagt über akute, heftige lumbale Rückenschmerzen mit Ausstrahlung in den rechten ventrolateralen Oberschenkel bis zum Knie nach gestriger Gartenarbeit.\" [cite: 96]\nB (Hintergrund): \"Die Patientin hat keine traumatische Vorgeschichte, zeigt jedoch ein akut beeinträchtigtes Gangbild mit ausgeprägter linksseitiger Schonhaltung.\" [cite: 97]\nA (Assessment): \"Subjektiv besteht ein Instabilitätsgefühl im Knie. Objektiv zeigt sich eine Kraftminderung bei der Knieextension rechts gegen Widerstand. Vitalkriterien sind stabil (BD 130/80, Puls 78, Temp. 36.8°C). Es liegen aktuell keine Miktions- oder Defäkationsstörungen vor.\" [cite: 98]\nR (Recommendation): \"Ich empfehle eine zeitnahe ärztliche Untersuchung zur Überprüfung des Patellarsehnenreflexes sowie die Festlegung der analgetischen Akuttherapie und die Indikationsstellung für ein florides CT/MRT der Lendenwirbelsäule.\" [cite: 99]"
  },
  ...
  // ==========================================
  {
    ...
    modelAnswer: "Fersengang: Der Patient wird aufgefordert, ein Stück ausschließlich auf den Fersen zu gehen[cite: 116]. Bei einer L5-Schädigung ist dies auf der betroffenen (linken) Seite nicht möglich; der Vorfuß sinkt ab [cite: 117].\n\nManueller Widerstandstest: Der Patient befindet sich in Rückenlage oder sitzt an der Bettkante[cite: 118]. Der Untersucher drückt den Fuß und die große Zehe nach unten (Plantarflexion), während der Patient maximal versucht, den Fuß und die große Zehe nach oben zu ziehen (Dorsalextension)[cite: 119]. Der Seitenvergleich dokumentiert das Defizit [cite: 120].\n\nKennmuskel: M. extensor hallucis longus (Großzehenbewegung) und M. tibialis anterior (Fußextension)[cite: 121]."
  },
  {
    id: "schwer-003-q4",
    caseId: "case-02",
    ...
    modelAnswer: "1. Gefahr von Stürzen (00155) R/T neuromuskulärer Dysfunktion (Fußheberparese links, Fußklatschen) und sensiblen Störungen des linken Fußes[cite: 123].\n\n2. Wissensdefizit (00126) bezüglich rückenschonender Ergonomie am Arbeitsplatz R/T mangelndem Wissen über ergonomische Hebetechniken bei körperlich belastender Arbeit (Beruf: Fliesenleger)[cite: 124]."
  },
  {
    id: "schwer-003-q5",
    caseId: "case-02",
    ...
    modelAnswer: "PI: \"Hier spricht [Name], Pflege Ambulanz. Ich melde Herrn M., 44 Jahre, mit dringlicher neurochirurgischer Priorität.\" [cite: 126]\nS: \"Es besteht der hochgradige Verdacht auf ein akutes lumboradikuläres Syndrom L5 links mit progredienter Fußheberparese.\" [cite: 127]\nB: \"Der Patient arbeitet als Fliesenleger, die Beschwerden bestehen seit 3 Tagen, heute kam es zur akuten Verschlechterung des Gangbildes.\" [cite: 128]\nA: \"Der Patient zeigt ein deutliches Fußklatschen links, der Fersengang ist links komplett aufgehoben. Parästhesien an der großen Zehe links sind vorhanden. Reithosenanästhesie sowie Miktions- oder Defäkationsstörungen wurden explizit verneint. Vitalzeichen stabil, schmerzbedingt hypertone Werte (BD 155/90).\" [cite: 129, 132]\nR: \"Aufgrund des motorischen Ausfalls (Fußheberparese) empfehle ich die sofortige neurochirurgische Konsiliärbeurteilung und die prioritäre Anmeldung für ein Notfall-MRT zur Dekompressions-Indikation.\" [cite: 132]"
  },
  ...
  // ==========================================
  {
    ...
    modelAnswer: "Wurzelsyndrom: Lumboradikuläres Syndrom (LRS) der Nervenwurzel S1 rechts (Segment LWK 5/ SWK 1), ausgelöst durch ein akutes Hebetrauma [cite: 135].\n\nPathophysiologische Verknüpfung: Die Unfähigkeit, sich auf die Zehenspitzen zu stellen, resultiert aus der Parese des M. triceps surae (Kennmuskel für S1), welcher für die Plantarflexion des Fußes zuständig ist[cite: 138]. Weitere assoziierte Muskeln sind der M. gluteus maximus und der M. biceps femoris [cite: 139].\n\nReflexgeschehen: Der korrespondierende Eigenreflex ist der Achillessehnenreflex (ASR)[cite: 140]. Im pathologischen Zustand (Wurzelkompression) ist der ASR auf der rechten Seite im Seitenvergleich abgeschwächt oder komplett erloschen[cite: 140]."
  },
  {
    id: "schwer-005-q2",
    caseId: "case-03",
    ...
    modelAnswer: "Erhebung der Faktoren: Fragen, ob Husten, Niesen oder Pressen (Erhöhung des Liquordrucks) den Schmerz verstärken[cite: 142]. Prüfen, ob das Herabhängenlassen der Beine oder flaches Liegen Entlastung bringt[cite: 143].\n\nEvidenzbasierte Beratung:\n- Bettruhe vermeiden: Striktes Einhalten von Bettruhe über mehr als 2 Tage ist nachweislich ungünstig. Alltagsaktivitäten sollten im Schmerzrahmen beibehalten werden (Bewegung fördert die Heilung) [cite: 145, 146].\n- Schmerzmedikation: Konsequente, vorübergehende Einnahme der verordneten Analgetika, um schmerzfreie Bewegung zu ermöglichen und Chronifizierung/Schonhaltungen zu verhindern [cite: 147].\n- Lagerung: Zur akuten Entlastung in Ruhephasen wird die Stufenbettlagerung empfohlen[cite: 148]."
  },
  {
    id: "schwer-005-q4",
    caseId: "case-03",
    ...
    modelAnswer: "1. Akuter Schmerz (00132) R/T mechanischer Kompression der Nervenwurzel S1 infolge Hebetraumas A/E/B stechende Schmerzen dorsal im rechten Bein, Unfähigkeit des Zehenstandes[cite: 160].\n\n2. Gefahr einer Muskelatrophie / Aktivitätsintoleranz (00092) R/T schmerzbedingter Immobilisation und motorischer Schwäche des M. triceps surae (Schonhaltung, Vermeidung von Belastung)[cite: 161]."
  },
  {
    id: "schwer-005-q5",
    caseId: "case-03",
    ...
    modelAnswer: "PI: \"Hallo, hier spricht [Name] von Station [X]. Ich rufe an wegen Herrn K., 39 Jahre, Raum [Y].\" [cite: 163]\nS: \"Herr K. hat ein akutes S1-Syndrom rechts nach einem Hebetrauma vor zwei Tagen mit starkem radikulären Schmerz.\" [cite: 164]\nB: \"Ausgelöst durch das Heben einer Waschmaschine. Zustand verschlechtert sich beim Versuch aufzutreten.\" [cite: 165]\nA: \"Der Lasègue-Test ist bei ca. 40° rechts stark positiv mit typischer radikulärer Ausstrahlung bis zum lateralen Fußrand. Der Zehenspitzenstand rechts ist motorisch nicht möglich (Schwäche M. triceps surae). Der Achillessehnenreflex ist rechts im Seitenvergleich erloschen. Keine Blasen-Mastdarm-Symptome vorhanden.\" [cite: 166]\nR: \"Ich empfehle eine zeitnahe ärztliche Visite zur Verordnung einer suffizienten Schmerztherapie (Stufenschema) zur Remobilisation sowie die Organisation einer physiotherapeutischen Mitbetreuung und die Einleitung der bildgebenden Diagnostik.\" [cite: 167]"
  },
  ...
  // ==========================================
  {
    ...
    modelAnswer: "Intrinsische Risikofaktoren (von der Person ausgehend):\n- Höheres Lebensalter (82 Jahre) [cite: 174]\n- Kognitive Beeinträchtigung / akute Verwirrtheit (leicht desorientiert) [cite: 175]\n- Haltungs- und Gangschwäche / Balanceschwierigkeiten bei der Mobilisation [cite: 176]\n- Positive Sturzanamnese (Sturz zu Hause vor 3 Monaten) [cite: 177]\n- Akute funktionelle Einschränkung (Zustand nach Knie-TEP) [cite: 178]\n- Erhöhter Toilettendrang (bekannte Dranginkontinenz) [cite: 179]\n\nExtrinsische Risikofaktoren (von der Umgebung ausgehend):\n- Polypharmazie / Risikomedikation (Sedativum zur Nacht, postoperative Analgetika) [cite: 181]\n- Medizinische Geräte am Körper (liegender IV-Zugang / Infusionskabel als Stolperfalle) [cite: 182]\n- Stationsumgebung (fremde Umgebung für die desorientierte Patientin)[cite: 184]."
  },
  {
    id: "schwer-006-q3",
    caseId: "case-04",
    ...
    modelAnswer: "Geh- und Sprechtest (Dual-Tasking): Der Pflegende geht mit der Patientin eine kurze Strecke auf dem Flur spazieren, ohne zu sprechen[cite: 198]. Nach einigen Minuten beginnt ein normales Gespräch[cite: 199]. Bleibt die Patientin beim Sprechen abrupt stehen (\"Stopping on talking\"), zeigt dies eine verminderte Exekutivfunktion durch kognitive Überforderung und ist ein valider Prädiktor für ein erhöhtes Sturzrisiko [cite: 199, 200].\n\n5-Meter-Gehtest: Eine Strecke von exakt 5 Metern wird flach auf dem Boden markiert[cite: 201]. Die Patientin legt diese Strecke so schnell wie möglich mit ihren gewohnten Hilfsmitteln zurück (Zeitmessung per Stoppuhr) [cite: 202].\n\nGrenzwerte: Eine Zeit von > 3,57 Sekunden zeigt eine Gefährdung im Straßenverkehr an[cite: 205]. Eine Zeit von > 33,3 Sekunden dokumentiert massive Alltagsschwierigkeiten und eine hochgradige Instabilität[cite: 206]."
  },
  {
    id: "schwer-006-q4",
    caseId: "case-04",
    ...
    modelAnswer: "Pflegediagnose: Sturzgefahr (00155) R/T reduzierter muskulärer Leistung der unteren Extremitäten (Z.n. Knie-TEP), Balanceschwierigkeiten, akuter Verwirrtheit, Einnahme von Sedativa und drängendem Toilettendrang bei Dranginkontinenz A/E/B positiver Sturzanamnese und Festhalten an den Wänden beim Gehen[cite: 208].\n\nPräventionsmaßnahmen:\n1. Umgebungsanpassung: Bett auf niedrigste Höhe (Niederflurbett), barrierefreie Umgebung (IV-Kabel sichern), Nachtlicht ein, Rufanlage in Reichweite[cite: 210].\n2. Inkontinenzmanagement: Strukturiertes Toilettengangs-Training (z.B. aktives Anbieten vor Verabreichung des nächtlichen Sedativums)[cite: 211, 212].\n3. Schuhwerk: Konsequentes Sicherstellen von geschlossenem, rutschfestem Schuhwerk bei jedem Transfer[cite: 213].\n4. Überwachung: Regelmäßige visuelle Kontrollen nachts; Vermeidung von freiheitsbeschränkenden Fixierungen (Bettgitter), da diese das Verletzungsrisiko bei Überkletterungsversuchen drastisch erhöhen[cite: 214, 215, 216]."
  },
  {
    id: "schwer-006-q5",
    caseId: "case-04",
    ...
    modelAnswer: "1. Akutphase & Triage (ABCDE-Schema): Critical Bleeding (Stoppen massiver Blutungen)[cite: 219, 220]. Airway/Breathing/Circulation (Vitalzeichen erheben)[cite: 221]. Disability (Vigilanz/Pupillen prüfen zum Ausschluss eines SHT)[cite: 222]. Exposure (Körperinspektion im Bett auf Frakturen, Hämatome, Beinlängenverkürzung prüfen, Wärmeerhalt sichern)[cite: 223].\n2. Arzt-Information: Unverzügliche Meldung zur medizinischen Diagnostik (Ausschluss innerer Verletzungen, Komplikationen der Knie-TEP)[cite: 224].\n3. Sturzdokumentation: Lückenlose Erfassung im klinischen Sturzprotokoll (Datum, Uhrzeit, Hergang, Zustand davor/danach, Folgen, informierte Personen)[cite: 225].\n4. Re-Evaluation & Anpassung: Analyse der Ursache (z.B. Sedativum zu stark?), Sturzrisiko neu einschätzen (STRATIFY/TUG) und Pflegeplan anpassen, um Folge-Rezidive zu verhindern[cite: 228, 229, 230]."
  },
  ...
  // ==========================================
  {
    ...
    modelAnswer: "Klinische Priorität: Unmittelbare, kritische Lebensgefahr durch Verbluten (Exsanguination)[cite: 320]. Das klassische ABCDE-Schema wird zum <c>ABCDE-Schema erweitert (kleines „c“ steht für Critical Bleeding)[cite: 320]. Eine arterielle Extremitätenblutung führt innert weniger Minuten zum hämorrhagischen Schock; Atemwege (A) und Belüftung (B) sind nachrangig, solange das Volumen spritzend verloren geht [cite: 321, 322].\n\nAntizipierte Schockform: Hypovolämischer Schock (spezifisch: hämorrhagischer Schock), gefolgt von der tödlichen Trias der Trauma-Pathophysiologie (Hypothermie, Azidose, Koagulopathie)[cite: 323]."
  },
  {
    id: "schwer-007-q2",
    caseId: "case-05",
    ...
    modelAnswer: "Gezielte Kurzinformationen während der physischen Blutstillung:\n1. Unfallmechanismus (Trauma-Kinetik): „Aus welcher genauen Höhe sind Sie gefallen und sind Sie primär auf den Kopf, das Becken oder die Beine aufgeschlagen?“ [cite: 325]\n2. Gerinnungsstatus (Noxen/Medikation): „Nehmen Sie regelmäßig blutverdünnende Medikamente ein (z. B. Marcumar, Aspirin, Eliquis)?“ [cite: 326]\n3. Symptomwahrnehmung / Vigilanz: „Fühlen Sie sich schwindelig, wird Ihnen schwarz vor den Augen oder haben Sie Durst?“ [cite: 327]"
  },
  {
    id: "schwer-007-q4",
    caseId: "case-05",
    ...
    modelAnswer: "1. Gefahr eines hypovolämischen Schocks (00205) R/T massivem, spritzendem arterio-venösen Blutverlust sekundär nach schwerem Sturztrauma[cite: 341].\n\n2. Akuter Schmerz (00132) R/T Gewebekontinuitätstrennung (Lazeration) und muskuloskelettalem Trauma des Oberschenkels A/E/B lautes Stöhnen, Gesichtsmimik, Schmerzäußerung[cite: 342]."
  },
  {
    id: "schwer-007-q5",
    caseId: "case-05",
    ...
    modelAnswer: "I: \"Hier spricht [Name], Ersthelfer/Pflegekraft. Ich melde einen traumatologischen Schockraum-Notfall.\" [cite: 344]\nS: \"Herr V., 34 Jahre, nach Sturz aus 3m Höhe mit kritischer, spritzender Oberschenkelblutung rechts.\" [cite: 345]\nB: \"Sturz von der Leiter auf Blechkante vor ca. 10 Minuten. Keine Vorerkrankungen bekannt.\" [cite: 346]\nA: \"c-Problem: Spritzende Blutung mittels Tourniquet-Anlage am rechten Oberschenkel um 11:45 Uhr erfolgreich gestoppt. Peripherer Puls rechts erloschen. Wunde zusätzlich verpackt. A-B-Probleme: Atemwege frei, Atmung suffizient. D-Problem: Patient ansprechbar, GCS 15, klagt über massive Oberschenkelschmerzen. Immobilisation der HWS eingeleitet. Patient mittels Decke gegen Hypothermie geschützt.\" [cite: 347]\nR: \"Ich fordere den Notarzt mit Sonderrechten an. Vorbereitung von großlumigen peripheren Zugängen und Volumen-/Transfusionstherapie bei Eintreffen erforderlich.\" [cite: 348]"
  },
  ...
  // ==========================================
  {
    ...
    caseId: "case-06",
    difficulty: "schwer",
    caseDescription: "Im Rahmen Ihres Dienstes in der interdisziänzitären Notaufnahme wird Frau T. (28 Jahre) nach einem ungebremsten Sturz mit dem E-Bike eingeliefert. Sie trug keinen Helm. Bei der Übernahme ist die Patientin somnolent (Augenöffnen nur auf lautes Ansprechen), reagiert verlangsamt, ist zeitlich und örtlich desorientiert. Es zeigt sich eine großflächige Schürfwunde und Hämatombildung parietal rechts sowie eine sichtbare Fehlstellung des linken Unterarms.",
    ...
    modelAnswer: "Verdachtsdiagnose: Schädel-Hirn-Trauma (SHT) Grad II (mittelschwer) bis Grad III (schwer), kombiniert mit einer dislozierten Unterarmfraktur links (V.a. distale Radiusfraktur)[cite: 351]. Die Somnolenz, Desorientierung und das parietale Hämatom nach ungebremstem Sturz ohne Helm beweisen eine direkte intrakranielle Beteiligung [cite: 352].\n\nTriage-Klassifikation: Kategorie Rot / Sofort (ESI Level 1-2)[cite: 353]. Das neurologische Defizit (D-Problem) hat absolute Priorität vor der orthopädischen Extremitätenfraktur. Eine Fraktur ist ein lokales Strukturproblem; ein SHT gefährdet direkt das Atemzentrum und das Überleben durch Hirndrucksteigerung[cite: 354, 357]."
  },
  {
    id: "schwer-008-q2",
    caseId: "case-06",
    ...
    modelAnswer: "Erhebung primär über Rettungsdienst oder Zeugen (da Patientin desorientiert) [cite: 359]:\n- Amnesie / Bewusstlosigkeit: „Gab es direkt nach dem Aufprall eine Phase der kompletten Bewusstlosigkeit, wenn ja, wie viele Minuten dauerte diese an?“ [cite: 360]\n- Vegetative Symptome: „Hat sich die Patientin vor Ort erbrochen oder über massive Übelkeit geklagt?“ [cite: 361]\n- Unfallhergang: „Ist sie primär mit dem Kopf aufgeprallt und gab es ein direktes Monokel-/Brillenhämatom oder Flüssigkeitsaustritt (Liquorrhoe) aus Nase oder Ohren?“ [cite: 362]"
  },
  {
    id: "schwer-008-q4",
    caseId: "case-06",
    ...
    modelAnswer: "1. Gefahr einer unwirksamen zerebralen Gewebedurchblutung (00201) R/T traumatischem Ödem / intrakranieller Blutung nach Schädel-Hirn-Trauma A/E/B Somnolenz, verlangsamter Reaktion, zeitlicher/örtlicher Desorientierung[cite: 378].\n\n2. Beeinträchtigte Gewebeintegrität (00044) R/T mechanischem Trauma A/E/B struktureller Fehlstellung des linken Unterarms, parietalem Hämatom und Schürfwunden[cite: 379]."
  },
  {
    id: "schwer-008-q5",
    caseId: "case-06",
    ...
    modelAnswer: "I: \"Hier spricht [Name], Notaufnahme. Ich übergebe Frau T., 28 Jahre, nach E-Bike-Sturz.\" [cite: 381]\nS: \"Patientin präsentiert sich mit einem mittelschweren SHT, Somnolenz und klinisch dislozierter Unterarmfraktur links.\" [cite: 382, 385]\nB: \"Sturz ohne Helm vor ca. 30 Minuten. Keine anamnestischen Vorerkrankungen eruierbar.\" [cite: 386]\nA: \"A-B stabil. C: Hämodynamisch stabil (BD 140/85, Puls 64). D: Neurologisch herabgesetzt, GCS 11. Pupillen sind isokor und prompt lichtreagibel, Patientin ist desorientiert. E: Sichtbare Fehlstellung linker Unterarm, PDMS-Kontrolle ist intakt (Puls tastbar, Rekap 1,5s, Finger beweglich). HWS ist mittels Stifneck immobilisiert.\" [cite: 387]\nR: \"Ich fordere die unfallchirurgische und neurochirurgische Akutvisite an. Prioritär ist die Anmeldung für ein Notfall-CCT zum Ausschluss einer intrakraniellen Blutung, gefolgt vom Röntgen des linken Unterarms und Analgetika-Gabe.\" [cite: 388]"
  },
  ...
  // ==========================================
  {
    ...
    modelAnswer: "Arbeitshypothese: Akutes Erysipel (Wundrose) des rechten Unterschenkels[cite: 391]. Bakterielle Infektion der tiefen Dermis (meist durch beta-hämolysierende Streptokokken der Gruppe A)[cite: 392]. Typisch sind die flammende, scharf begrenzte Rötung, Schwellung (Ödem), lokale Überwärmung sowie systemische Entzündungszeichen (Fieber, Schüttelfrost, Lymphadenopathie inguinal) [cite: 393].\n\nAbgrenzung zur Lymphangitis: Die Lymphangitis ist eine bakterielle Entzündung der Lymphbahnen[cite: 394]. Sie äußert sich morphologisch durch linear verlaufende, streifenförmige, unregelmäßig begrenzte rote Linien, die von der Wunde herzwärts ziehen[cite: 395]. Ein Erysipel hingegen breitet sich flächig und scharf begrenzt im Gewebe aus[cite: 396]."
  },
  {
    id: "schwer-009-q2",
    caseId: "case-07",
    ...
    modelAnswer: "1. Eintrittspforten / Barrierefunktion: „Haben Sie neben der Schramme vom Rasenmähen chronische Hautveränderungen am Fuß, wie zum Beispiel einen juckenden Hautpilz zwischen den Zehen (Tinea pedis) oder eingerissene Fersen?“ [cite: 399]\n2. Zirkulatorische Risikofaktoren: „Liegen bei Ihnen Durchblutungsstörungen der Arterien (pAVK) oder eine chronische Venenschwäche mit Krampfadern oder dicken Beinen (chronisch-venöse Insuffizienz) vor?“ [cite: 400]\n3. Metabolische Risikofaktoren: „Sind bei Ihnen Stoffwechselerkrankungen wie Diabetes mellitus bekannt und wie ist Ihre aktuelle Blutzuckereinstellung?“ [cite: 401]"
  },
  {
    id: "schwer-009-q3",
    caseId: "case-07",
    ...
    modelAnswer: "Inspektion & Palpation: Symmetrievergleich beider Beine[cite: 406]. Zwingende Maßnahme: Ränder der scharf begrenzten Rötung mit wasserfestem Hautmarkierungsstift dokumentieren (inkl. Datum/Uhrzeit), um die Ausbreitung/Rückgang zu beurteilen[cite: 407, 408].\n\nLymphknoten-Palpation: Sanftes Abtasten der Inguinalregion (Leiste) im Seitenvergleich. Ein schmerzhafter, geschwollener Lymphknoten bestätigt die lymphogene Keimausbreitung [cite: 409].\n\nPflegetherapeutische Lagerung: Strikte Ruhigstellung und Hochlagerung der betroffenen Extremität (fördert Rückfluss, reduziert Ödem/Gewebedruck)[cite: 410, 411]. Lokale Applikation von kühlen, feuchten Umschlägen[cite: 412]. Einreibungen oder Massagen sind absolut kontraindiziert[cite: 413]."
  },
  {
    id: "schwer-009-q4",
    caseId: "case-07",
    ...
    modelAnswer: "1. Beeinträchtigte Hautintegrität (00046) R/T bakterieller Invasion der Lederhaut über eine Bagatellverletzung A/E/B flammender, scharf begrenzter Rötung, Schwellung, lokaler Überwärmung und Schmerzen am rechten Unterschenkel[cite: 415].\n\n2. Hyperthermie (00007) R/T systemischer Infektionsreaktion (bakterielle Toxinfreisetzung) A/E/B Körpertemperatur von 38.7°C, Frösteln, Tachykardie und schmerzhafter inguinaler Lymphadenopathie[cite: 416]."
  },
  {
    id: "schwer-009-q5",
    caseId: "case-07",
    ...
    modelAnswer: "I: \"Hallo, hier spricht [Name] aus der Ambulanz. Ich stelle Ihnen Herrn Weber, 65 Jahre, vor.\" [cite: 418]\nS: \"Hochgradiger Verdacht auf ein ausgeprägtes Erysipel am rechten Unterschenkel mit starker systemischer Komponente.\" [cite: 419]\nB: \"Bagatellverletzung vor 4 Tagen beim Rasenmähen. Rapide Größenzunahme der Rötung seit gestern.\" [cite: 420]\nA: \"Objektiv zeigt sich eine flammende, scharf begrenzte Rötung und Ödem des rechten Schienbeinbereiches. Die Ränder wurden markiert. Inguinale Lymphknoten rechts sind deutlich tastbar und druckdolent. Patient hat Fieber mit 38,7 °C, fröstelt. Vitalzeichen: BD 125/80, Puls 92/min.\" [cite: 421]\nR: \"Der Patient benötigt eine umgehende ärztliche Verordnung einer hochdosierten, kalkulierten intravenösen Antibiotikatherapie sowie eine antiphlogistische Analgetikatherapie. Ich habe das Bein bereits hochgelagert und gekühlt.\" [cite: 422]"
  },
  ...
  // ==========================================
  {
    ...
    caseId: "case-08",
    difficulty: "schwer",
    caseDescription: "Bei der Ganzkörperwaschung einer bettlägerigen, multimorbiden Patientin, Frau L. (79 Jahre, fortgeschrittene Demenz, schwere Stuhl- und Urininkontinenz), entdecken Sie im Sakralbereich eine tiefe Wunde. Es zeigt sich ein vollständiger loss der Hautschichten; subkutanes Fettgewebe ist sichtbar, Muskeln oder Knochen liegen nicht frei. Die Wundränder sind unregelmäßig, der Wundgrund ist teilweise mit gelblichem Schorf belegt. Ringsherum, flächig über beide Gesäßhälften verteilt, zeigt sich eine glänzende, diffus begrenzte, intensiv rosa-rote Hautveränderung mit kleinen, oberflächlichen Hautdefekten (Erosionen).",
    ...
    modelAnswer: "Entitäten:\n1. Dekubitus Grad 3 (nach EPUAP/NPUAP): Betrifft die tiefe Läsion sakral[cite: 428]. Vollständiger Hautverlust bis in die Subkutis (Fettgewebe sichtbar, Muskeln/Knochen liegen nicht frei) mit Slough/Gewebebelag[cite: 429, 430].\n2. Inkontinenz-assoziierte Dermatitis (IAD): Betrifft die diffuse, rosa-rote, feuchte Veränderung mit Erosionen über beiden Gesäßhälften[cite: 431]. Chemisch-irritative Mazeration der Hautbarriere durch permanenten Kontakt mit Stuhl/Urin[cite: 432]."
  },
  {
    id: "schwer-010-q2",
    caseId: "case-08",
    ...
    modelAnswer: "Fremdeinschätzungsinstrumente wie BESD (Beurteilung von Schmerz bei Demenz) / PAINAD müssen eingesetzt werden[cite: 434]. Systematische Beobachtung während einer Belastungssituation (z.B. Umlagern)[cite: 435]. Erfasst werden:\n- Atmung (lautes, angestrengtes Atmen, Schnaufen) [cite: 437]\n- Negative Lautäußerungen (Stöhnen, Ächzen, Jammern) [cite: 438]\n- Gesichtsausdruck (Grimassieren, Stirnrunzeln) [cite: 439]\n- Körpersprache (Abwehrhaltung, Ballen der Fäuste, Rigidität) [cite: 440]\n- Trostbedürftigkeit (Nicht beruhigbar)[cite: 441]."
  },
  {
    id: "schwer-010-q3",
    caseId: "case-08",
    ...
    modelAnswer: "Fingerdrucktest: Bleibt ein Erythem nach Druck nicht wegdrückbar, liegt ein Dekubitus vor[cite: 443]. Ist es wegdrückbar (wird kurz weiß), handelt es sich um eine irritative Rötung (IAD) [cite: 444].\n\nMorphologischer Vergleich:\n- Lokalisation: Dekubitus liegt zentriert über Knochenprominenzen (Sakrum)[cite: 446]; IAD liegt flächig in Hautfalten/Gesäß ohne direkten Knochenbezug [cite: 447].\n- Symmetrie: Dekubitus ist meist asymmetrisch[cite: 448]; IAD ist spiegelbildlich/symmetrisch auf beiden Gesäßhälften [cite: 448].\n- Farbe & Rand: Dekubitus Grad 3 zeigt scharf begrenzte Ränder, der Wundgrund ist tief und nekrotisch/fibrinös[cite: 451]. IAD zeigt diffus begrenzte Ränder, intensiv glänzende rosa-rote Farbe, flach ohne tiefen Gewebeverlust[cite: 452]."
  },
  {
    id: "schwer-010-q4",
    caseId: "case-08",
    ...
    modelAnswer: "1. Beeinträchtigte Gewebeintegrität (00044) R/T anhaltendem mechanischem Druck und Scherkräften bei Bettlägerigkeit A/E/B Gewebedefekt bis in die Subkutis im Sakralbereich, Belagbildung (Dekubitus Grad 3)[cite: 454].\n\n2. Beeinträchtigte Hautintegrität (00046) R/T permanentem chemisch-irritativem Kontakt mit Exkrementen (Stuhl-/Urininkontinenz) und Mazeration A/E/B diffuser, glänzender Rötung beider Gesäßhälften mit oberflächlichen Erosionen (IAD)[cite: 455]."
  },
  {
    id: "schwer-010-q5",
    caseId: "case-08",
    ...
    modelAnswer: "I: \"Guten Tag, hier spricht [Name] vom Wundteam/Station. Ich melde Frau L., 79 Jahre, Zimmer [X].\" [cite: 457]\nS: \"Neuentdeckung eines Dekubitus Grad 3 sakral, überlagert von einer schweren IAD beider Glutaeen.\" [cite: 458]\nB: \"Patientin ist bettlägerig, demenzkrank und leidet unter schwerer Doppelinkontinenz.\" [cite: 459]\nA: \"Objektiv: Sakraler Gewebedefekt ca. 3x4 cm, Subkutis sichtbar, Fibrinbelag. Flächige IAD mit kutanen Erosionen ringherum. Schmerzassessment via BESD zeigt einen Score von 4/10 beim Lagern.\" [cite: 460]\nR: \"1. Kausaltherapie Dekubitus: Freilagerung sakral mittels 30°-Wechsellagerung, Evaluation einer Anti-Dekubitus-Matratze. Arzt-Konsil für hydroaktive Wundauflage nach Debridement. 2. Kausaltherapie IAD: Striktes Inkontinenzmanagement, atmungsaktive Hilfen (keine Folien), Reinigung mit pH-neutralen Lipogelen, Applikation eines Hautschutzfilms (z.B. Cavilon). 3. Analgetika vor Transfers.\" [cite: 461, 462, 463, 464, 465]"
  },
  ...
  // ==========================================
  {
    ...
    modelAnswer: "Verdachtshypothese: Hochgradiger klinischer Verdacht auf ein Malignes Melanom (Schwarzer Hautkrebs) am oberen Rücken [cite: 468].\n\nEffloreszenzenlehre: Der Ausgangsbefund stellt primär eine Makula (Fleck) dar (Farbveränderung im Hautniveau ohne Substanzänderung)[cite: 469]. Da die Stelle jedoch „leicht erhaben“ ist, hat sie sich sekundär zu einem Plaque oder Nodulus (Knoten) umentwickelt, was ein vertikales Tumorwachstum in die Tiefe und Breite dokumentiert[cite: 470, 473]."
  },
  {
    id: "schwer-011-q2",
    caseId: "case-09",
    ...
    modelAnswer: "Risikoprofil: Als Landschaftsgärtner liegt eine chronische, jahrzehntelange Ganzjahres-UV-Exposition (Sonnenstrahlung) vor, welche der primäre Karzinogenese-Faktor für DNA-Schäden der Melanozyten ist[cite: 475, 476].\n\nDrei offene Fragen:\n1. Größen- und Formveränderung: „Wann genau ist Ihnen oder Ihrer Frau dieser Fleck das erste Mal aufgefallen und hat er sich in den letzten Wochen oder Monaten in seiner Größe oder Form merklich verändert?“ [cite: 478]\n2. Blutungsneigung: „Ist die Hautstelle beim Abtrocknen nach dem Duschen oder bei Reibung durch Kleidung schon einmal aufgegangen oder hat spontan geblutet?“ [cite: 479]\n3. Sensibilitätsstörungen: „Können Sie das Missempfinden genauer beschreiben – bleibt es beim gelegentlichen Jucken oder brennt die Stelle zeitweise?“ [cite: 480]"
  },
  {
    id: "schwer-011-q3",
    caseId: "case-09",
    ...
    modelAnswer: "Anwendung der ABCDE-Regel:\n- A = Asymmetrie: Läsion ist explizit asymmetrisch [cite: 483, 484].\n- B = Begrenzung: Unregelmäßig, ausgefranst und unscharf zum gesunden Gewebe hin [cite: 485, 486].\n- C = Color (Farbe): Ausgeprägte Polychromie (Hellbraun, Tiefschwarz bis Bläulich) [cite: 487, 488].\n- D = Durchmesser: Beträgt 8 mm (Werte > 6 mm sind tumorverdächtig) [cite: 489].\n- E = Evolution/Erhabenheit: Stelle juckt neu und ist tastbar erhaben [cite: 490, 491].\n\nUgly Duckling Sign (Das hässliche Entlein): Dieses Prinzip besagt, dass wenn eine einzelne Hautläsion komplett aus dem individuellen Muttermal-Muster einer Person herausfällt, diese unabhängig von der ABCDE-Regel sofort biopsiepflichtig ist[cite: 492]."
  },
  {
    id: "schwer-011-q4",
    caseId: "case-09",
    ...
    modelAnswer: "1. Bereitschaft für ein verbessertes Gesundheitsmanagement (00162) bezüglich dermatologischer Prävention R/T geäußertem Wunsch nach Begutachtung einer verdächtigen Hautstelle bei beruflicher UV-Exposition[cite: 494].\n\n2. Wissensdefizit (00126) bezüglich effektivem UV-Eigenschutz und Hautkrebs-Früherkennung R/T mangelnder Aufklärung über berufsbedingte Gesundheitsrisiken A/E/B Arbeiten im Freien ohne dokumentierte Screening-Historie[cite: 497]."
  },
  {
    id: "schwer-011-q5",
    caseId: "case-09",
    ...
    modelAnswer: "I: \"Guten Tag, hier spricht [Name]. Ich wende mich an Sie bezüglich einer dermatologischen Konsilanforderung für Herrn G., 52 Jahre.\" [cite: 499]\nS: \"Es liegt ein hochgradig positiver ABCDE-Befund einer pigmentierten Hautläsion am oberen Rücken vor, V.a. Malignes Melanom.\" [cite: 500]\nB: \"Der Patient arbeitet seit Jahrzehnten im Freien als Landschaftsgärtner, UV-Exposition ist chronisch erhöht. Bisher kein Hautkrebsscreening erfolgt.\" [cite: 501]\nA: \"Objektive Kriterien: Asymmetrischer, unscharf begrenzter Plaque, 8 mm Durchmesser, polychrom (braun/schwarz/blau), tastbar erhaben am oberen Scapulabereich rechts. Subjektiv wird ein intermittierender Pruritus angegeben.\" [cite: 502]\nR: \"Ich empfehle die dringliche Überweisung an einen niedergelassenen Dermatologen bzw. die dermatologische Hochschulambulanz zur Durchführung einer Dermatoskopie und zur zeitnahen Durchführung einer Exzisionsbiopsie (R0-Resektion).\" [cite: 503]"
  },
  ...
  // ==========================================
  {
    ...
    modelAnswer: "Arbeitshypothese: Akute Appendizitis (Wurmfortsatzentzündung) [cite: 605].\n\nPathophysiologie:\n- Schmerzwanderung: Der initiale viszerale Schmerz entsteht durch die Dehnung des Appendixlumens (diffus periumbilikal)[cite: 607]. Erst mit dem Übergreifen auf das somatisch sensible Peritoneum parietale lokalisiert sich der Schmerz im rechten Unterbauch [cite: 608].\n- Temperatursprung: Ein Unterschied zwischen rektaler und axillärer Körpertemperatur von Delta T >= 0,8–1,0 °C ist ein klassischer Indikator für einen floriden, lokalisierten Entzündungsprozess im kleinen Becken/Abdomen [cite: 609].\n- Schonhaltung: Beugung im Hüftgelenk entlastet den M. psoas major, welcher direkt an den entzündeten Appendix grenzt[cite: 610]."
  },
  {
    id: "schwer-012-q2",
    caseId: "case-10",
    ...
    modelAnswer: "Gezielte offene Fragen zum Ausschluss von Komplikationen[cite: 612]:\n1. Perforationsschmerz (plötzlicher Abriss): „Haben Sie im Verlauf einen plötzlich einschießenden, extrem vernichtenden Schmerz gespürt, der kurzfristig nachließ und dann in einen dauerhaften, brennenden Ganzbauchschmerz übergegangen ist?“ [cite: 613, 614]\n2. Darmperistaltik-Stopp: „Wann hatten Sie den letzten Stuhlgang und konnten Sie in den letzten 24 Stunden problemlos Winde abgeben?“ [cite: 615]\n3. Schock-Symptome: „Fühlen Sie sich schwindelig, zittrig oder haben Sie kalten Schweiß auf der Stirn bemerkt?“ [cite: 616]"
  },
  {
    id: "schwer-012-q4",
    caseId: "case-10",
    ...
    modelAnswer: "1. Akuter Schmerz (00132) R/T biologischem Schädigungsfaktor (lokalisierte Entzündung des Peritoneum parietale / Appendix) A/E/B Schmerzwanderung in den rechten Unterbauch, Schmerzscore > 6/10, Schonhaltung beim Gehen[cite: 632].\n\n2. Gefahr eines Flüssigkeitsdefizits (00028) R/T gastrointestinaler Störung (Erbrechen, verminderte orale Aufnahme bei Appetitlosigkeit) und Hyperthermie[cite: 633]."
  },
  {
    id: "schwer-012-q5",
    caseId: "case-10",
    ...
    modelAnswer: "PI: \"Hallo, hier spricht [Name] aus der ZNA. Ich melde ein akutes Abdomen zur viszeralchirurgischen Akutvisite.\" [cite: 635]\nS: \"Jan, 21 Jahre, präsentiert sich mit hochgradigem Verdacht auf akute Appendizitis.\" [cite: 636]\nB: \"Schmerzbeginn gestern periumbilikal, im Verlauf in den rechten Unterbauch gewandert. Einmaliges Erbrechen.\" [cite: 637]\nA: \"Hämodynamisch stabil (BD 120/75, Puls 84). Axillär 37,6 °C, rektal 38,5 °C (Delta T=0,9°C). McBurney, Lanz- und Psoas-Zeichen rechts stark positiv. Blumberg-Zeichen positiv. Abdomen weich, keine generalisierte Abwehrspannung. Letzter Stuhlgang heute Morgen, Winde gehen ab.\" [cite: 638]\nR: \"Ich empfehle die sofortige chirurgische Visite, Anlage eines venösen Zugangs, Abnahme der laborchemischen Entzündungsparameter (Leukozyten, CRP) sowie die Vorbereitung für eine abdominelle Sonographie.\" [cite: 639]"
  },
  ...
  // ==========================================
  {
    ...
    modelAnswer: "Krankheitsbild: Akuter Ileus (Darmverschluss) mit fortgeschrittenem Miserere (Koterbrechen) [cite: 644].\n\nDifferenzierung:\n- Mechanischer Ileus: Physisches Hindernis im Darmlumen (z.B. postoperative Verwachsungen/Briden)[cite: 646]. Auskultation: Hyperperistaltik / Stenoseperistaltik. Hochgestellte, spritzende, metallisch-klingende Darmgeräusche, da die Muskulatur gegen das Hindernis ankämpft [cite: 647].\n- Paralytischer Ileus: Neurogene oder myogene Lähmung der Darmmotorik (häufig postoperativatonisch)[cite: 648]. Auskultation: Absolutes Fehlen von Darmgeräuschen („Totenstille“)[cite: 649]."
  },
  {
    id: "schwer-013-q2",
    caseId: "case-11",
    ...
    modelAnswer: "Gezielte offene Fragen zur Genese [cite: 651]:\n- Schmerzcharakter: „Sind die Bauchschmerzen dauerhaft anhaltend drückend oder treten sie wellenartig-krampfartig (kolikartig) mit kurzen Pausen auf?“ [cite: 652]\n- Medikation: „Welche Schmerzmedikamente haben Sie nach der Operation erhalten – nehmen Sie stark wirkende Pflaster oder Tabletten wie Opiate (Morphium) ein?“ [cite: 654]\n- Erbrechen-Dynamik: „Können Sie beschreiben, wann das Erbrechen begonnen hat und ob die Flüssigkeit von Anfang an diese dunkle Farbe und den fäkalen Geruch hatte?“ [cite: 655]"
  },
  {
    id: "schwer-013-q3",
    caseId: "case-11",
    ...
    modelAnswer: "Befunde: Palpation zeigt prall gespanntes Abdomen[cite: 659]. Perkussion zeigt hochgradig tympanitischen Klopfschall über allen Quadranten durch Gasansammlung (Meteorismus)[cite: 660]. Auskultation zeigt je nach Form Totenstille oder metallische Geräusche [cite: 647, 649].\n\nZwingende Restriktionen: Strikte Nahrungskarenz (Null per os) wegen Aspirations- und Rupturgefahr[cite: 662]. KEINE Einläufe oder Laxantien bei mechanischem Ileus, da Peristaltiksteigerung gegen ein mechanisches Hindernis zur Perforation führt[cite: 663]. Ausnahme: darmstimulierende Maßnahmen nach ärztlicher Verordnung nur beim rein paralytischen Ileus[cite: 664]."
  },
  {
    id: "schwer-013-q4",
    caseId: "case-11",
    ...
    modelAnswer: "1. Gefahr einer Aspiration (00039) R/T unstillbarem, schwallartigem Koterbrechen (Miserere) bei gastrointestinaler Obstruktion / Passageaufhebung und liegender Position[cite: 668].\n\n2. Akuter Schmerz (00132) R/T mechanischer Dehnung und intramuraler Drucksteigerung der Darmschlingen A/E/B krampfartigen Bauchschmerzen, schmerzhaftem Völlegefühl, gespanntem Abdomen[cite: 669]."
  },
  {
    id: "schwer-013-q5",
    caseId: "case-11",
    ...
    modelAnswer: "I: \"Hier spricht [Name], Station Chirurgie. Ich melde einen akuten viszeralchirurgischen Notfall.\" [cite: 671]\nS: \"Frau K., 72 Jahre, entwickelt am 5. postoperativen Tag das klinische Bild eines manifesten Ileus mit Koterbrechen.\" [cite: 672]\nB: \"Zustand nach gynäkologischer Laparotomie. Seit 36 Stunden kompletter Stopp von Stuhl und Wind.\" [cite: 673]\nA: \"Abdomen massiv meteoristisch aufgetrieben, tympanitischer Klopfschall. Auskultation zeigt hochgestellte, metallisch-klingende Geräusche (V.a. mechanischen Ileus durch Briden). Patientin erbricht aktuell fäkal. Vitalzeichen: BD 110/70, Puls 102 (Tachykardie), afebril.\" [cite: 674]\nR: \"Ich fordere die sofortige chirurgische Evaluation zur OP-Indikation. Ich habe die Patientin komplett nüchtern gesetzt, den Oberkörper hochgelagert und benötige die Verordnung für die sofortige Anlage einer entlastenden Magensonde sowie für parenterale Flüssigkeits- und Elektrolytsubstitution.\" [cite: 675]"
  },
  ...
  // ==========================================
  {
    ...
    modelAnswer: "Hauptdiagnose: Dekompensierte Leberzirrhose mit Aszites, Caput medusae und schmerzlosem intrahepatischem Ikterus [cite: 678].\n\nBilirubinmechanismus: Beim Erythrozytenabbau entsteht indirektes Bilirubin, das zur Leber transportiert wird[cite: 680, 681]. In der Zirrhoseleber ist die Konjugation zu direktem Bilirubin gestört bzw. der Abfluss blockiert[cite: 682, 683]. Bilirubin kumuliert im Blut (Hyperbilirubinämie) und diffundiert ins Gewebe (Gelbfärbung) [cite: 684].\n- Entfärbter Stuhl (acholisch): Es fehlt das Abbauprodukt Sterkobilin im Kolon, das die braune Farbe verleiht [cite: 687].\n- Bierbrauner Urin: Wasserlösliches Bilirubin wird kompensatorisch über die Nieren als Urobilin ausgeschieden[cite: 688]."
  },
  {
    id: "schwer-014-q2",
    caseId: "case-12",
    ...
    modelAnswer: "Screening auf Hepatische Enzephalopathie (HE) infolge mangelnder Ammoniak-Entgiftung [cite: 690]:\n- Bewusstseinslage / Vigilanz: Prüfung auf ausgeprägte Verlangsamung, Schlaf-Wach-Rhythmus-Umkehr (nächtliche Unruhe, tagsüber Apathie/Somnolenz)[cite: 691].\n- Kognition: Orientierung zu Person, Ort und Zeit testen; Schreibproben durchführen lassen[cite: 692].\n- Neuromuskulär: Überprüfung des Flapping Tremor (Asterixis) via Überstrecken der Hände dorsal. Ein flügelartiges Absinken bestätigt HE Stadium I-II[cite: 693, 694]."
  },
  {
    id: "schwer-014-q3",
    caseId: "case-12",
    ...
    modelAnswer: "Leberhautzeichen: Palmarerythem, Weißnägel, Spider-Naevi, glatte Lackzunge, Bauchglatze (Verlust der Sekundärbehaarung) und Caput medusae [cite: 698, 699, 700].\n\nAszites-Nachweis (Shifting Dullness): Mittig zeigt sich tympanitischer Klopfschall, in den Flanken gedämpfter Schenkelschall[cite: 703]. Bei Seitenlage verlagert sich die Dämpfungsgrenze nach unten, während die Darmschlingen nach oben steigen [cite: 704, 705].\n\nKratzauskultation der Leber: Stethoskop epigastrisch fixieren[cite: 706]. Mit dem Fingernagel parallel zum Rippenbogen von kranial nach kaudal kratzen[cite: 707]. Beim Erreichen der soliden Lebergrenze wird das Geräusch schlagartig laut (Bestimmung der Lebergröße)[cite: 708, 711]."
  },
  {
    id: "schwer-014-q4",
    caseId: "case-12",
    ...
    modelAnswer: "1. Flüssigkeitsüberschuss (00026) R/T portalem Hochdruck, vermindertem kolloidosmotischem Druck (Hypalbuminämie) und renaler Natrium-Wasser-Retention A/E/B massivem Aszites, prall vorgewölbtem Abdomen, Caput medusae[cite: 713].\n\n2. Gefahr einer akuten Verwirrtheit (00173) oder Risiko einer hepatischen Enzephalopathie R/T Akkumulation neurotoxischer Substanzen (Ammoniak) bei hepatozellulärer Insuffizienz[cite: 714]."
  },
  {
    id: "schwer-014-q5",
    caseId: "case-12",
    ...
    modelAnswer: "I: \"Hallo, hier spricht [Name] von Station. Ich stelle Ihnen Herrn D., 55 Jahre, mit dekompensierter Leberzirrhose vor.\" [cite: 716]\nS: \"Patient präsentiert sich mit ausgeprägtem schmerzlosen Ikterus, massivem Aszites und beginnenden neuro-psychiatrischen Defiziten.\" [cite: 717]\nB: \"Chronischer Äthylismus bekannt. Akute Verschlechterung der Vigilanz (Apathie) seit heute.\" [cite: 718]\nA: \"Objektiv: Skleren- und Hautikterus vorhanden. Abdomen prall ausladend, Shifting Dullness positiv. Caput medusae und Spider-Naevi sichtbar. Stuhl acholisch, Urin bierbraun. Neurologisch: Patient ist apathisch, verlangsamt, leichter Asterixis auslösbar (V.a. HE Stadium I).\" [cite: 719]\nR: \"Ich empfehle die sofortige laborchemische Bestimmung des Ammoniakspiegels, der Transaminasen und des Gerinnungsstatus (INR/Quick). Pflegerisch leiten wir ein striktes Flüssigkeitsbilanzierungs-Protokoll ein. Bitte um Verordnung von Lactulose-Sirup oral zur Ammoniakelimination.\" [cite: 720]"
  }
